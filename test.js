...
const styles = StyleSheet.create({
      ...
      title: { fontSize: 32, fontWeight: 'bold', color: ISO_COLORS.text },
      subtitle: { color: '#8D99AE', marginTop: 5 },
      card: { backgroundColor: ISO_COLORS.card, padding: 30, borderRadius: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 10, elevation: 5 },
      label: { fontSize: 12, fontWeight: 'bold', color: ISO_COLORS.text, marginBottom: 8, textTransform: 'uppercase' },
      input: { borderBottomWidth: 1, borderBottomColor: ISO_COLORS.border, marginBottom: 25, paddingVertical: 8, fontSize: 16, color: ISO_COLORS.text },
      btn: { backgroundColor: ISO_COLORS.primary, padding: 18, borderRadius: 12, alignItems: 'center' },
